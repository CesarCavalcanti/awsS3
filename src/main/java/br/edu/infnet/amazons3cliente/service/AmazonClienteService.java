package br.edu.infnet.amazons3cliente.service;
...
public class AmazonClienteService {
    ...
    private void iniciarAmazonS3(){
        ...
        s3client = AmazonS3ClientBuilder.standard().withRegion(regiao).withCredentials(awsStaticCredentialsProvider).build();
    }
    ...
    private File converter (MultipartFile file) throws IOException {
